...
const EventPlayer = (props: { cctvId: string, facId: string, rtsp:string }) => {

    let playerId = PLAYER_ID_PREFIX + props.facId;

    // cctv 재생되는 숫자
    const reloadCnt = useSelector((state: RootState) => state.view.event.gis.eventVideoReloadCnt);
