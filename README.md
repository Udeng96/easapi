...
- **사내 IoT 플랫폼을 활용한 수위계 업체 연계** 및 시설물 관리 기능 개발
- 수위계의 수위 정도를 **지도 기반 마커와 차트를 통해 시각화**
- **공공데이터 포털 기상정보·기상특보 매시간 자동 업데이트** 개발 (Quartz 스케줄러)
- **WebSocket 기반 실시간 이벤트 알림** 기능 구현
- **Netty 기반 외부 IoT 소켓 서버**(`RinoEvent`) 구현으로 외부 수위계 시스템과 실시간 연동
